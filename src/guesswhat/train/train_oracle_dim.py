...
#from guesswhat.data_provider.guesswhat_dataset import OracleDatasetCustom
...
if __name__ == '__main__':
    ...
    parser.add_argument("-custom_train_set", action="store_true", default=None)
    parser.add_argument("-non_deceptive", action="store_true")
    ...
    if args.custom_train_set:
        #trainset = OracleDatasetCustom(args.custom_train_set)
        trainset = OracleDataset.load(args.data_dir, "train_new", image_builder, crop_builder)
    else:
    ...
    if args.non_deceptive:
        scopename = 'oracle'
    else:
        scopename = 'deceptive_oracle'
    network = OracleNetwork(config, num_words=tokenizer.no_words, scopename=scopename)
