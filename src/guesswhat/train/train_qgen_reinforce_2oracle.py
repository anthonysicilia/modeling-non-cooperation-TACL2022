...
from guesswhat.models.looper.basic_looper_dim import BasicLooper
...
if __name__ == '__main__':
    ...
    parser.add_argument("-restore_guesser", action="store_true", help="Restore previous guesser training")
    ...
    ## ADDED
    deceptive_oracle_config = get_config_from_xp(os.path.join(args.networks_dir, "oracle"), args.deceptive_oracle_identifier)
    ...
    ## ADDED
    deceptive_oracle_network = OracleNetwork(oracle_config, num_words=tokenizer.no_words, scopename='deceptive_oracle')
    ...
    guesser_network = DeceptiveGuesserNetwork(guesser_config["model"], num_words=tokenizer.no_words)
    ...
    if args.train_guesser:
        optimizer['guesser'], _ = create_optimizer(guesser_network, guesser_config)
    ...
    with tf.Session(config=tf.ConfigProto(gpu_options=gpu_options)) as sess:
        ...
        guesser_wrapper = DeceptiveGuesserWrapper(guesser_network)
